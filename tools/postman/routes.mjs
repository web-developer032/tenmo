...
export const routes = [
  ...
  // Account / profile
  // ============================================================
  { group: 'profile', persona: 'sara', method: 'GET', path: '/api/profile', expect: [200],
    summary: "Read the caller's profile" },
  { group: 'profile', persona: 'sara', method: 'PATCH', path: '/api/profile', expect: [200],
    body: { full_name: 'Sara Khan (updated)', preferred_name: 'Sara' },
    summary: "Update the caller's profile" },
  { group: 'profile', persona: 'jordan', method: 'PATCH', path: '/api/profile', expect: [200],
    body: { emergency_contact: { name: 'Layla Lee', relationship: 'Sister', phone: '+44 7700 900220' } },
    summary: "Update the caller's emergency contact (tenant JSONB field)" },
  { group: 'profile', persona: 'sara', method: 'POST', path: '/api/profiles/lookup-by-email', expect: [200],
  ...
  // Orgs
  // ============================================================
  { group: 'orgs', persona: 'nina', method: 'POST', path: '/api/orgs', expect: [201],
    body: {
      name: 'Smoke Test Lets',
      slug: 'smoke-test-lets',
      business_address: { line1: '1 Smoke St', city: 'Birmingham', postcode: 'B1 1AA', country: 'GB' },
      contact_email: 'nina@example.com',
    },
    summary: 'Create a new landlord org', notes: 'Nina is a brand-new landlord with no orgs yet.' },
  { group: 'orgs', persona: 'sara', method: 'GET', path: '/api/orgs/{{saraOrgId}}/properties', expect: [200],
    summary: "List the org's properties" },
  { group: 'orgs', persona: 'sara', method: 'POST', path: '/api/orgs/{{saraOrgId}}/properties', expect: [201],
    body: {
  ...
  { group: 'orgs', persona: 'sara', method: 'GET', path: '/api/orgs/{{saraOrgId}}/tenancies', expect: [200],
    summary: "List the org's tenancies" },
  { group: 'orgs', persona: 'sara', method: 'POST', path: '/api/orgs/{{saraOrgId}}/tenancies', expect: [201],
    body: {
  ...
  { group: 'orgs', persona: 'sara', method: 'GET', path: '/api/orgs/{{saraOrgId}}/compliance', expect: [200],
    summary: 'List org compliance items' },
  { group: 'orgs', persona: 'sara', method: 'POST', path: '/api/orgs/{{saraOrgId}}/compliance', expect: [201],
    body: { type: 'pat_test', property_id: '{{saraPropertyId}}', expires_at: '2030-06-01' },
    summary: 'Create a compliance item' },
  { group: 'orgs', persona: 'sara', method: 'POST', path: '/api/orgs/{{saraOrgId}}/compliance/seed', expect: [200, 201],
  ...
  // Properties / rooms
  // ============================================================
  { group: 'properties', persona: 'sara', method: 'GET', path: '/api/properties/{{saraPropertyId}}/rooms', expect: [200],
    summary: 'List rooms in a property' },
  { group: 'properties', persona: 'sara', method: 'POST', path: '/api/properties/{{saraPropertyId}}/rooms', expect: [201],
    body: {
  ...
  // ============================================================
  { group: 'tenancies', persona: 'jordan', method: 'GET', path: '/api/tenancies/{{jordanTenancyId}}', expect: [200],
    summary: "Get a single tenancy (tenant viewing their own)" },
  { group: 'tenancies', persona: 'jordan', method: 'GET', path: '/api/tenancies/{{jordanTenancyId}}/charges', expect: [200],
    summary: 'List rent charges for a tenancy' },
  { group: 'tenancies', persona: 'jordan', method: 'GET', path: '/api/tenancies/{{jordanTenancyId}}/payments', expect: [200],
    summary: 'List rent payments for a tenancy' },
  { group: 'tenancies', persona: 'sara', method: 'POST', path: '/api/tenancies/{{jordanTenancyId}}/payments', expect: [201],
    body: { amount_pence: 1000, charge_id: '{{jordanChargeId}}', method: 'manual_bank_transfer', paid_on: '2026-05-23' },
    summary: 'Record a manual rent payment',
    notes: 'Smoke uses tiny amount; cleanup deletes the row.' },
  { group: 'tenancies', persona: 'sara', method: 'POST', path: '/api/tenancies/{{taylorInviteTenancyId}}/cancel', expect: [200, 422],
    summary: 'Cancel a pending tenancy invite',
    notes: '422 on rerun: the invite is already cancelled.' },
  { group: 'tenancies', persona: 'sara', method: 'POST', path: '/api/tenancies/{{jordanTenancyId}}/end', expect: [200],
    body: { reason: 'mutual_break', end_date: '2030-12-31' },
    summary: 'End an active tenancy (Renters Rights Bill notice rules apply)',
    skipInSmoke: true, notes: 'Mutating end of seeded active tenancy disrupts other smokes.' },

  // ============================================================
  // Invites (token-based)
  // ============================================================
  { group: 'invites', persona: 'public', method: 'GET', path: '/api/invites/{{marcusInviteToken}}', expect: [200],
    summary: 'Public invite preview (redacted)' },
  { group: 'invites', persona: 'public', method: 'POST', path: '/api/invites/{{marcusInviteToken}}/accept', expect: [401, 403, 404, 200],
    summary: 'Accept invite — requires auth as the invited email',
    skipInSmoke: true, notes: 'Requires a user matching the invite email; not idempotent.' },

  // ============================================================
  // Listings (public discovery)
  // ============================================================
  { group: 'listings', persona: 'public', method: 'GET', path: '/api/listings', expect: [200],
    summary: 'Search published listings (anon — redacted address)' },
  { group: 'listings', persona: 'public', method: 'GET', path: '/api/listings/{{publishedRoomId}}', expect: [200],
    summary: 'Single published listing detail' },
  { group: 'listings', persona: 'jordan', method: 'POST', path: '/api/listings/{{publishedRoomId}}/apply', expect: [201, 409],
  ...
  // ============================================================
  { group: 'landlord-listings', persona: 'sara', method: 'POST', path: '/api/landlord/{{saraOrgSlug}}/listings/{{saraRoom4Id}}/publish', expect: [200, 422],
    body: { description: 'Smoke test publish — please ignore.', available_from: '2030-01-01', min_term_months: 6 },
    summary: 'Publish a room listing',
    notes: '422 on rerun: listing already closed by the previous close call.' },
  { group: 'landlord-listings', persona: 'sara', method: 'POST', path: '/api/landlord/{{saraOrgSlug}}/listings/{{saraRoom4Id}}/pause', expect: [200, 422],
    body: { resume: false },
    summary: 'Pause a published listing',
    notes: '422 on rerun: listing already closed.' },
  { group: 'landlord-listings', persona: 'sara', method: 'POST', path: '/api/landlord/{{saraOrgSlug}}/listings/{{saraRoom4Id}}/close', expect: [200, 422],
    body: { reopen: false },
    summary: 'Close a listing',
    notes: '422 on rerun: listing already closed.' },
  { group: 'landlord-listings', persona: 'sara', method: 'GET', path: '/api/landlord/{{saraOrgSlug}}/listings/{{publishedRoomId}}/applications', expect: [200],
    summary: 'List applications for a room' },
  { group: 'landlord-applications', persona: 'sara', method: 'POST', path: '/api/landlord/{{saraOrgSlug}}/applications/{{rileyApplicationId}}/reject', expect: [200, 422],
  ...
  { group: 'landlord-applications', persona: 'sara', method: 'POST', path: '/api/landlord/{{saraOrgSlug}}/applications/{{rileyApplicationId}}/accept', expect: [200, 409],
  ...
  { group: 'tenant-applications', persona: 'riley', method: 'POST', path: '/api/tenant/applications/{{rileyApplicationId}}/withdraw', expect: [200],
    summary: 'Withdraw an application',
    skipInSmoke: true, notes: 'Mutates the seeded pending application that other smokes rely on.' },

  // ============================================================
  // Compliance
  // ============================================================
  { group: 'compliance', persona: 'sara', method: 'GET', path: '/api/compliance/{{saraComplianceItemId}}', expect: [200],
    summary: 'Get a compliance item' },
  { group: 'compliance', persona: 'sara', method: 'PATCH', path: '/api/compliance/{{saraComplianceItemId}}', expect: [200],
    body: { notes: 'Smoke test note.' },
    summary: 'Update a compliance item' },
  { group: 'compliance', persona: 'sara', method: 'DELETE', path: '/api/compliance/{{saraComplianceItemId}}', expect: [200, 204],
    summary: 'Delete a compliance item',
    skipInSmoke: true, notes: 'Mutates seeded compliance set; left for manual Postman drive.' },

  // ============================================================
  // AST envelopes
  // ============================================================
  { group: 'ast', persona: 'marcus', method: 'POST', path: '/api/ast/envelopes', expect: [201, 409, 422, 503],
    body: { tenancy_id: '{{marcusCamden2TenancyId}}' },
    summary: 'Start an AST signing run',
    notes: 'Hits DocuSeal; requires DOCUSEAL_API_URL + DOCUSEAL_API_TOKEN. 503 expected if not configured.' },
  { group: 'ast', persona: 'marcus', method: 'GET', path: '/api/ast/envelopes/{{marcusCamden2AstId}}', expect: [200],
    summary: 'Get an envelope' },
  { group: 'ast', persona: 'marcus', method: 'DELETE', path: '/api/ast/envelopes/{{marcusCamden2AstId}}', expect: [200, 204],
    summary: 'Cancel an open envelope',
    skipInSmoke: true, notes: 'Mutates the only open envelope; left for manual Postman drive.' },

  // ============================================================
  // Documents
  // ============================================================
  { group: 'documents', persona: 'sara', method: 'GET', path: '/api/documents?property_id={{saraPropertyId}}', expect: [200],
    summary: 'List documents filtered by parent' },
  { group: 'documents', persona: 'sara', method: 'POST', path: '/api/documents/upload-url', expect: [200, 201],
    body: {
  ...
  { group: 'documents', persona: 'sara', method: 'POST', path: '/api/documents', expect: [201],
    body: {
      parent: { kind: 'property', property_id: '{{saraPropertyId}}' },
      category: 'other',
      storage_path: '{{saraOrgId}}/property/{{saraPropertyId}}/smoke-record.pdf',
      filename: 'smoke-record.pdf', mime_type: 'application/pdf', size_bytes: 2048,
      title: 'Smoke record', description: 'Inserted by smoke runner.',
    },
    summary: 'Record an uploaded document',
    skipInSmoke: true, notes: 'Storage path uniqueness — script-side flag avoids the collision on rerun.' },
  { group: 'documents', persona: 'sara', method: 'GET', path: '/api/documents/{{saraDocumentId}}/url', expect: [200, 404],
    summary: 'Mint a signed download URL',
    notes: 'Storage object is not actually uploaded in the seed, so signing may 404 — acceptable for smoke.' },
  { group: 'documents', persona: 'sara', method: 'DELETE', path: '/api/documents/{{saraDocumentId}}', expect: [200, 204],
    summary: 'Delete a document',
    skipInSmoke: true, notes: 'Mutates seed; left for manual Postman drive.' },

  // ============================================================
  // Notifications
  // ============================================================
  { group: 'notifications', persona: 'jordan', method: 'GET', path: '/api/notifications', expect: [200],
    summary: "List the caller's notifications" },
  { group: 'notifications', persona: 'jordan', method: 'PATCH', path: '/api/notifications', expect: [200],
    summary: 'Mark all notifications read' },
  { group: 'notifications', persona: 'jordan', method: 'PATCH', path: '/api/notifications/mark-read', expect: [200],
  ...
  { group: 'notifications', persona: 'jordan', method: 'GET', path: '/api/notifications/preferences', expect: [200],
    summary: 'Get notification preferences' },
  { group: 'notifications', persona: 'jordan', method: 'PATCH', path: '/api/notifications/preferences', expect: [200],
  ...
  // ============================================================
  { group: 'conversations', persona: 'jordan', method: 'GET', path: '/api/conversations', expect: [200],
    summary: 'Inbox list' },
  { group: 'conversations', persona: 'sara', method: 'POST', path: '/api/conversations', expect: [200, 201],
  ...
  { group: 'conversations', persona: 'jordan', method: 'GET', path: '/api/conversations/{{jordanConversationId}}/messages', expect: [200],
    summary: 'List messages in a conversation' },
  { group: 'conversations', persona: 'jordan', method: 'POST', path: '/api/conversations/{{jordanConversationId}}/messages', expect: [201],
    body: { body: 'Smoke test message — please ignore.' },
    summary: 'Send a message' },
  { group: 'conversations', persona: 'jordan', method: 'GET', path: '/api/conversations/{{jordanConversationId}}/participants', expect: [200],
    summary: 'List participants' },
  { group: 'conversations', persona: 'jordan', method: 'PATCH', path: '/api/conversations/{{jordanConversationId}}/read', expect: [200],
    summary: 'Mark conversation read' },

  // ============================================================
  // Tickets
  // ============================================================
  { group: 'tickets', persona: 'jordan', method: 'POST', path: '/api/tickets', expect: [201],
    body: {
      property_id: '{{saraPropertyId}}',
      room_id: '{{saraRoom1Id}}',
  ...
  { group: 'tickets', persona: 'jordan', method: 'GET', path: '/api/tickets/{{jordanTicketId}}', expect: [200],
    summary: 'Get a ticket detail' },
  { group: 'tickets', persona: 'sara', method: 'PATCH', path: '/api/tickets/{{jordanTicketId}}/status', expect: [200, 422],
    body: { status: 'in_progress' },
    summary: 'Change a ticket status',
    notes: '422 on rerun: status transitions are validated and a no-op transition is rejected.' },
  { group: 'tickets', persona: 'sara', method: 'PATCH', path: '/api/tickets/{{jordanTicketId}}/assign', expect: [200],
    body: { assigned_to_user_id: '{{saraId}}' },
    summary: 'Assign a ticket' },
  { group: 'tickets', persona: 'jordan', method: 'POST', path: '/api/tickets/{{jordanTicketId}}/messages', expect: [201],
    body: { body: 'Smoke comment from tenant.' },
    summary: 'Add a comment to a ticket' },
  { group: 'tickets', persona: 'jordan', method: 'POST', path: '/api/tickets/{{jordanTicketId}}/attachments/upload-url', expect: [200, 201],
    body: { filename: 'smoke.jpg', mime_type: 'image/jpeg', size_bytes: 2048 },
    summary: 'Mint signed attachment upload URL' },
  { group: 'tickets', persona: 'jordan', method: 'POST', path: '/api/tickets/{{jordanTicketId}}/attachments/sign', expect: [200, 201, 404],
  ...
  // Bills
  // ============================================================
  { group: 'bills', persona: 'sara', method: 'GET', path: '/api/bills?property_id={{saraPropertyId}}', expect: [200],
    summary: 'List bills for a property' },
  { group: 'bills', persona: 'sara', method: 'POST', path: '/api/bills', expect: [201],
    body: {
      property_id: '{{saraPropertyId}}',
      type: 'electricity',
  ...
  { group: 'bills', persona: 'sara', method: 'GET', path: '/api/bills/{{saraBillId}}', expect: [200],
    summary: 'Get a bill detail' },
  { group: 'bills', persona: 'sara', method: 'PATCH', path: '/api/bills/{{saraBillId}}', expect: [200],
    body: { notes: 'Smoke updated.' },
    summary: 'Update a bill' },
  { group: 'bills', persona: 'sara', method: 'DELETE', path: '/api/bills/{{saraBillId}}', expect: [200, 204],
  ...
  // ============================================================
  { group: 'billing', persona: 'sara', method: 'POST', path: '/api/billing/checkout', expect: [200, 201, 400, 500, 502, 503],
    body: { org_id: '{{saraOrgId}}', tier: 'pro' },
    summary: 'Create a Stripe Checkout session',
    notes: 'Requires STRIPE_SECRET_KEY + STRIPE_PRICE_PRO_MONTHLY. 4xx/5xx expected if Stripe not configured.' },
  { group: 'billing', persona: 'sara', method: 'POST', path: '/api/billing/portal', expect: [200, 201, 400, 500, 502, 503],
    body: { org_id: '{{saraOrgId}}' },
    summary: 'Create a Stripe Customer Portal session',
    notes: 'Requires STRIPE_SECRET_KEY + an existing Stripe customer (400 expected on a fresh org).' },

  // ============================================================
  // Payments (GoCardless rent collection)
  // ============================================================
  { group: 'payments', persona: 'jordan', method: 'POST', path: '/api/payments/mandates', expect: [200, 201, 500, 502, 503],
    body: { tenancy_id: '{{jordanTenancyId}}', success_redirect_url: 'http://localhost:3000/tenant/rent/{{jordanTenancyId}}/dd-callback' },
    summary: 'Start a Direct Debit mandate setup',
    notes: 'Hits GoCardless. 5xx expected if GOCARDLESS_ACCESS_TOKEN not set.' },
  { group: 'payments', persona: 'jordan', method: 'POST', path: '/api/payments/mandates/{{jordanMandateId}}/complete', expect: [200, 201, 404, 500],
  ...
  { group: 'payments', persona: 'jordan', method: 'DELETE', path: '/api/payments/mandates/{{jordanMandateId}}', expect: [200, 204],
    summary: 'Cancel a mandate',
    skipInSmoke: true, notes: 'Mutates seeded mandate; left for manual Postman drive.' },
  { group: 'payments', persona: 'sara', method: 'POST', path: '/api/payments/charges/{{jordanChargeId}}/collect', expect: [200, 201, 202, 403, 422, 500],
    body: { amount_pence: 1000 },
    summary: 'Trigger a one-off Direct Debit collection',
    notes: 'Tier-gated (rent_collection_dd). 202 expected if no active mandate (Stripe/GC unconfigured).' },

  // ============================================================
  // Passport (tenant)
  // ============================================================
  { group: 'passport', persona: 'jordan', method: 'GET', path: '/api/passport', expect: [200],
    summary: 'Assemble the Rental Passport JSON' },
  { group: 'passport', persona: 'jordan', method: 'POST', path: '/api/passport/pdf', expect: [200, 201, 500],
    body: {},
  ...
  // Admin
  // ============================================================
  { group: 'admin', persona: 'admin', method: 'GET', path: '/api/admin/audit?page=1&per_page=10', expect: [200],
    summary: 'Audit log' },
  { group: 'admin', persona: 'admin', method: 'GET', path: '/api/admin/orgs?page=1&per_page=10', expect: [200],
    summary: 'List orgs' },
  { group: 'admin', persona: 'admin', method: 'GET', path: '/api/admin/orgs/{{saraOrgId}}', expect: [200],
    summary: 'Org detail' },
  { group: 'admin', persona: 'admin', method: 'POST', path: '/api/admin/orgs/{{saraOrgId}}/subscription-override', expect: [200],
    body: { tier: 'pro', reason: 'Smoke test override.' },
    summary: 'Set or clear a manual tier override' },
  { group: 'admin', persona: 'admin', method: 'POST', path: '/api/admin/orgs/{{saraOrgId}}/suspend', expect: [200],
    body: { action: 'reinstate', reason: 'Smoke test reinstate (was never suspended).' },
    summary: 'Suspend / reinstate an org' },
  { group: 'admin', persona: 'admin', method: 'POST', path: '/api/admin/orgs/invite', expect: [200, 201],
    body: { org_name: 'Smoke Org', email: 'invited-landlord@example.com', tier: 'starter' },
    summary: 'Invite a landlord org (audit-only MVP)' },
  { group: 'admin', persona: 'admin', method: 'GET', path: '/api/admin/users?page=1&per_page=10', expect: [200],
    summary: 'List users' },
  { group: 'admin', persona: 'admin', method: 'GET', path: '/api/admin/users/{{jordanId}}', expect: [200],
    summary: 'User profile detail' },
  { group: 'admin', persona: 'admin', method: 'GET', path: '/api/admin/profiles/search?q=sara', expect: [200],
    summary: 'Search profiles by email/name' },
  { group: 'admin', persona: 'admin', method: 'POST', path: '/api/admin/settings', expect: [200],
    body: { trial_days: 14 },
    summary: 'Update platform settings (super only)' },
  { group: 'admin', persona: 'admin', method: 'POST', path: '/api/admin/team/invite', expect: [200, 201, 409],
  ...
  { group: 'admin', persona: 'admin', method: 'PATCH', path: '/api/admin/team/{{supportAdminId}}', expect: [200],
    body: { role: 'support' },
    summary: 'Update an admin role (super only)' },
  { group: 'admin', persona: 'admin', method: 'DELETE', path: '/api/admin/team/{{supportAdminId}}', expect: [200, 204],
    summary: 'Revoke a platform admin',
    skipInSmoke: true, notes: 'Mutates the seeded support admin.' },
  { group: 'admin', persona: 'admin', method: 'POST', path: '/api/admin/support/{{platformSupportTicketId}}/assign-me', expect: [200],
    summary: 'Self-assign a platform support ticket' },
  { group: 'admin', persona: 'admin', method: 'POST', path: '/api/admin/support/{{platformSupportTicketId}}/resolve', expect: [200, 422],
    body: { resolution: 'Smoke test resolve.' },
    summary: 'Resolve a platform support ticket',
    notes: '422 on rerun: ticket already resolved.' },
  { group: 'admin', persona: 'admin', method: 'POST', path: '/api/admin/compliance/notify', expect: [200, 201],
    body: { org_id: '{{saraOrgId}}', violation_id: '00000000-0000-0000-0000-000000000000', kind: 'reminder', note: 'Smoke test.' },
    summary: 'Notify a landlord of a compliance violation' },
  { group: 'admin', persona: 'admin', method: 'POST', path: '/api/admin/billing/{{saraOrgId}}/retry', expect: [200, 201, 501],
    summary: 'Retry a failed Stripe invoice (stub)',
    notes: '501 acceptable until wired to live Stripe API.' },
  { group: 'admin', persona: 'admin', method: 'POST', path: '/api/admin/billing/{{saraOrgId}}/remind', expect: [200, 201],
    summary: 'Send a card-update reminder' },

  // ============================================================
  // Cron (Bearer CRON_SECRET; localhost dev bypass when unset)
  // ============================================================
  { group: 'cron', persona: 'cron', method: 'GET', path: '/api/cron/rent-charges', expect: [200],
    summary: 'Generate rent charges (dry-run on GET)' },
  { group: 'cron', persona: 'cron', method: 'POST', path: '/api/cron/rent-charges', expect: [200, 201],
    summary: 'Generate rent charges + optionally collect via DD' },
  { group: 'cron', persona: 'cron', method: 'GET', path: '/api/cron/compliance-reminders', expect: [200],
    summary: 'Compliance reminders cron (dry-run on GET)' },
  { group: 'cron', persona: 'cron', method: 'POST', path: '/api/cron/compliance-reminders', expect: [200, 201],
    summary: 'Send compliance reminder emails' },

  // ============================================================
  // Webhooks (HMAC-signed; manual via Postman, opt-in for smoke)
  // ============================================================
  { group: 'webhooks', persona: 'webhook', method: 'POST', path: '/api/webhooks/stripe', expect: [200, 400],
    headers: { 'stripe-signature': 't=demo,v1=demo' },
    body: { id: 'evt_demo', type: 'invoice.payment_succeeded', data: { object: { id: 'in_demo' } } },
    summary: 'Stripe webhook (signed)',
    skipInSmoke: true, notes: 'Use `stripe trigger` for real events.' },
  { group: 'webhooks', persona: 'webhook', method: 'POST', path: '/api/webhooks/gocardless', expect: [200, 400],
    ...
    skipInSmoke: true, notes: 'Sign with GOCARDLESS_WEBHOOK_SECRET to test.' },
  { group: 'webhooks', persona: 'webhook', method: 'POST', path: '/api/webhooks/docuseal', expect: [200, 400],
    headers: { 'x-docuseal-signature': 'demo' },
    body: { event_type: 'submission.completed', data: { id: 'sub_demo' } },
    summary: 'DocuSeal webhook (signed)',
    skipInSmoke: true, notes: 'Sign with DOCUSEAL_WEBHOOK_SECRET to test.' },
];
