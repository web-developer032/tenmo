...
export default async function TenantPassportPage() {
  ...
  return (
    <div className="mx-auto w-full max-w-4xl space-y-5 lg:space-y-6">
      <PageHeader
        breadcrumbs={[{ label: 'Tenant', href: '/tenant' }, { label: 'Rental Passport' }]}
        title={
          <span className="inline-flex items-center gap-2">
            <BookUser className="h-5 w-5 text-forest-600" /> Rental Passport
          </span>
        }
        description="A portable record of who you are as a renter — your verified ID, payment history and tenancy record. Yours to take with you. Free, forever."
        actions={
